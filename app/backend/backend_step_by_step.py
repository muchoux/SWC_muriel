...
def PWCO(pvi, pvom, N, T, Xd, Nd, Xl, Xec, Xis, il, dec, Nis, Nl, source, q, Kp):
    """
...
def PWCI(ps, pg, N, T, epvs, epvg, source, Ks, Kg):
    """
...
def LCOE(pvi, Hopt, P, PR, rd, d, N, rom, pvom, T, Xd, Nd, source, Xl, Xec, Xis, il, dec, Nis, Nl, q, Kp):
    """Levelized Cost of Electricity (USD/kWh)"""
    epv_discounted = EPV_discounted(Hopt, P, PR, N, rd, d)
    #print("epv_discounted:", epv_discounted)
    pwco = PWCO(pvi, pvom, N, T, Xd, Nd, Xl, Xec, Xis, il, dec, Nis, Nl, source, q, Kp)
    return pwco / epv_discounted

def NPV(pvi, pvom, pg, ps, rpg, rps, rd, N, T, Nd, Xd, epvs, epvg, source, Xl, Xec, Xis, il, dec, Nis, Nl, Ks, Kg, q, Kp):
    """
    Net Present Value of the project (USD)
    Difference between present value of cash inflows and outflows
    """
    pwci = PWCI(ps, pg, N, T, epvs, epvg, source, Ks, Kg)
    pwco = PWCO(pvi, pvom, N, T, Xd, Nd, Xl, Xec, Xis, il, dec, Nis, Nl, source, q , Kp)
    #print("PW[CI]:", pwci)
    #print("LCC:", pwco)
    return pwci - pwco

def build_cashflow_series(pvi, epvs, epvg, ps, pg, rps, rpg, rd, d, N, T, pvom, source, rom):
    """
...
def run_simulation(source, d, rom, rps, rd, rpg, P, Cu, Hopt, 
                   PR, SCI, COM, N, Xl, Xec, il, dec, T, Xd, Nd, Xis, Nis, Nl,
                   ps, pg):
    ...
    pwco_result = PWCO(pvi, pvom, N, T, Xd, Nd, Xl, Xec, Xis, il, dec, Nis, Nl, source, q, Kp)
    pwci_result = PWCI(ps, pg, N, T, epvs, epvg, source, Ks, Kg)
    lcoe_result = LCOE(pvi, Hopt, P, PR, rd, d, N, rom, pvom, T, Xd, Nd, source,  Xl, Xec, Xis, il, dec, Nis, Nl, q, Kp)
    npv_result = NPV(pvi, pvom, pg, ps, rpg, rps, rd, N, T, Nd, Xd, epvs, epvg, source, Xl, Xec, Xis, il, dec, Nis, Nl, Ks, Kg, q, Kp)
    cashflows = build_cashflow_series(pvi, epvs, epvg, ps, pg, rps, rpg, rd, d, N, T, pvom, source, rom)
